...
const CreateCourseOption = ({activeItem}: Props) => {
  ...
  <div className='flex flex-col items '>       
       ...
       <p>Course Content</p>     <IoMdCheckmark className="text-[10px] min-lg:text-[20px] absolute ml-1"/>         
       </div>
      ...
      <div className={` ${activeItem >= 3 ? "bg-blue-500" : "bg-[#384766]"} max-md:hidden w-[5px] h-[50px] ml-[12px] mt-[1px]`}></div>
       ...
       <p>Course Preview</p>           <IoMdCheckmark className="text-[10px] min-lg:text-[20px] absolute ml-1"/>  
       </div>
