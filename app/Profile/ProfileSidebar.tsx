...
const ProfileSidebar = ({user,active,setActive }: Props) => {
  ...
  return (
    ...
    <div className={`${active === 1? `bg-gray-600` :"bg-gray-800"} hover:bg-gray-600 max-sm:w-fit cursor-pointer px-[10px] rounded-lg h-[40px] flex items-center gap-3`} onClick={()=>{setActive(1)}}>
    ...
    <div className={`${active === 2? `bg-gray-600` :"bg-gray-800"} w-fit hover:bg-gray-600  cursor-pointer px-[10px] rounded-lg h-[40px] flex items-center gap-3`} onClick={()=>{setActive(2)}}>
    ...
    <div className='max-sm:hidden'>Change Password</div>                          
     ...
     <div className={`${active === 3? `bg-gray-600` :"bg-gray-800"} w-fit hover:bg-gray-600  cursor-pointer px-[10px] rounded-lg h-[40px] flex items-center gap-3`} onClick={()=>{setActive(3)}}>
   ...
   <div className={`${active === 4 ? `bg-gray-600` : "bg-gray-800"} w-fit hover:bg-gray-600 px-[10px] cursor-pointer rounded-lg h-[40px] flex items-center gap-3`} onClick={() => { setActive(4); handleLogout()}}>
